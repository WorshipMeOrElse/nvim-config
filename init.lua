...
require("user.options.keybinds")
require("user.options.plugins")

require("user.aesthetics.bufferline")
require("user.aesthetics.colorscheme")
require("user.aesthetics.lualine")
...
require("user.utility.tree")
require("user.utility.telescope")
